...
<div id="slider-carousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="8000">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <!-- Slider 1 -->
        <div class="carousel-item active" style="background-image: url('assets/images/slider/img-1.jpg')">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <div class="slider-btn animated fadeInUp">
                                <a href="/pricing" class="btn bg-blue">Affordable Prices</a>
                                <a href="/contact" class="btn bg-white-default">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Slider 2 -->
        <div class="carousel-item" style="background-image: url('assets/images/slider/img-2.jpg')">
            <div class="carousel-caption">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
        ...
        <!-- Slider 3 -->
        <div class="carousel-item" style="background-image: url('assets/images/slider/img-3.jpg')">
            <div class="carousel-caption">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
